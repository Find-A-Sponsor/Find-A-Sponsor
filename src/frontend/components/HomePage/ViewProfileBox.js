  ...
  const handleNewPost = async (e) => {
    ...
    for (let i = 0; i <= arrayOfKeys.length; i++) {
      if (arrayOfKeys[i] === "images") {
        ...
        arrayOfKeys[i] === "video" &&
        state.newPost[arrayOfKeys[i]].size < 104857600
      ) {
    ...
    <form onSubmit={handleNewPost}>
      {contentError ? (
        ...
        <TextField
          ...
          defaultValue=""
          disabled={loading}
          onBlur={(e) => dispatch(createPosts(e.target.value, "text"))}
        />
      )}
      ...
      {state.newPost.images ? (
        <Button
          ...
          disabled={
            loading || errorMessage || state.newPost.video || state.newPost.gif
          }
          variant="contained"
          color={deleteItem ? "error" : "success"}
          style={{
            position: "absolute",
            left: "78%",
            top: "53%",
        ...
        >
          {state.newPost.images.length} Image/s
        </Button>
      ) : (
        <Button
          startIcon={
            contentError === "images" ? (
              <ImageTwoToneIcon style={{ color: "red" }} />
            ) : (
              <ImageTwoToneIcon />
            )
          }
          ...
          style={{
            ...
            borderRadius: "16px",
            color: contentError === "images" ? "red" : "",
            borderColor: contentError === "images" ? "red" : "",
          }}
          disabled={
            loading || errorMessage || state.newPost.video || state.newPost.gif
          }
      ...
      {state.newPost.video ? (
        <Button
          ...
          disabled={
            loading || errorMessage || state.newPost.images || state.newPost.gif
          }
          variant="contained"
          color={deleteVideo ? "error" : "success"}
          style={{
            position: "absolute",
            left: "85%",
            top: "53%",
        ...
        <Button
          startIcon={
            contentError === "video" ? (
              <VideocamTwoToneIcon style={{ color: "red" }} />
            ) : (
              <VideocamTwoToneIcon />
            )
          }
          ...
          style={{
            ...
            border: "1px solid rgba(45, 135, 255, 0.3)",
            borderRadius: "16px",
            color: contentError === "video" ? "red" : "",
            borderColor: contentError === "video" ? "red" : "",
          }}
          disabled={
            loading || errorMessage || state.newPost.images || state.newPost.gif
          }
      ...
      {state.newPost.gif ? (
        ...
        <Button
          startIcon={
            contentError === "gif" ? (
              <MovieFilterIcon style={{ color: "red" }} />
            ) : (
          ...
          style={{
            ...
            border: "1px solid rgba(45, 135, 255, 0.3)",
            borderRadius: "16px",
            color: contentError === "gif" ? "red" : "",
            borderColor: contentError === "gif" ? "red" : "",
          }}
          disabled={
            loading ||
            errorMessage ||
      ...
      {loading ? (
        <Button
          disabled
          startIcon={<Loading style={{ fontSize: "175%" }} color="white" />}
          variant="outlined"
          style={{
            position: "absolute",
            left: "77%",
        ...
        <Button
          disabled
          startIcon={<ErrorTwoToneIcon color="white" />}
          variant="outlined"
          style={{
            position: "absolute",
            left: "77%",
        ...
        <Button
          type="submit"
          startIcon={<SendTwoToneIcon style={{ fontSize: "175%" }} />}
          variant="outlined"
          style={{
            position: "absolute",
            left: "77%",
